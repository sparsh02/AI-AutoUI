...
export default function CodeTutorial() {
  ...
  // Specify the options object with key and description properties
  const copilotOptions = {
    key: "key",
    description: "Description of your Copilot value",
    value: codeToDisplay
  };

  // Use useCopilotReadable with the options object
  useCopilotReadable(copilotOptions);
